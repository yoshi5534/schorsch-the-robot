...
inline IllegalAccessibleComponentStateException::IllegalAccessibleComponentStateException(const ::rtl::OUString& Message_, const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XInterface >& Context_) SAL_THROW( () )
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::accessibility::IllegalAccessibleComponentStateException const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::accessibility::IllegalAccessibleComponentStateException const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::accessibility::IllegalAccessibleComponentStateException >::get();
}

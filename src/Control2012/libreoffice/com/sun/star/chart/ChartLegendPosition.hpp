...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::chart::ChartLegendPosition const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::chart::ChartLegendPosition const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::chart::ChartLegendPosition >::get();
}

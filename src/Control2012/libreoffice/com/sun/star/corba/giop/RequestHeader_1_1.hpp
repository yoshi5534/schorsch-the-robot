#ifndef INCLUDED_COM_SUN_STAR_CORBA_GIOP_REQUESTHEADER_1_1_HPP
#define INCLUDED_COM_SUN_STAR_CORBA_GIOP_REQUESTHEADER_1_1_HPP

#include "sal/config.h"

#include "com/sun/star/corba/giop/RequestHeader_1_1.hdl"
...
inline RequestHeader_1_1::RequestHeader_1_1() SAL_THROW( () )
    : service_context()
    , request_id(0)
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::corba::giop::RequestHeader_1_1 const *) {
    ...
    if (the_type == 0) {
        ::typelib_TypeDescriptionReference * the_members[] = {
            ...
            ::cppu::UnoType< ::cppu::UnoSequenceType< ::sal_Int8 > >::get().getTypeLibType() };
        ::typelib_static_struct_type_init(&the_type, "com.sun.star.corba.giop.RequestHeader_1_1", 0, 9, the_members, 0);
    }
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::corba::giop::RequestHeader_1_1 const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::corba::giop::RequestHeader_1_1 >::get();
}

#endif // INCLUDED_COM_SUN_STAR_CORBA_GIOP_REQUESTHEADER_1_1_HPP

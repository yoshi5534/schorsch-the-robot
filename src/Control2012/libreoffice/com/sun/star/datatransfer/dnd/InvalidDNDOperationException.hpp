...
inline InvalidDNDOperationException::InvalidDNDOperationException() SAL_THROW( () )
    : ::com::sun::star::uno::RuntimeException()
{ }

inline InvalidDNDOperationException::InvalidDNDOperationException(const ::rtl::OUString& Message_, const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XInterface >& Context_) SAL_THROW( () )
    : ::com::sun::star::uno::RuntimeException(Message_, Context_)
{ }

InvalidDNDOperationException::InvalidDNDOperationException(InvalidDNDOperationException const & the_other): ::com::sun::star::uno::RuntimeException(the_other) {}
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::datatransfer::dnd::InvalidDNDOperationException const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::datatransfer::dnd::InvalidDNDOperationException const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::datatransfer::dnd::InvalidDNDOperationException >::get();
}

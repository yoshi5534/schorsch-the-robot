...
inline EmptyUndoStackException::EmptyUndoStackException(const ::rtl::OUString& Message_, const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XInterface >& Context_) SAL_THROW( () )
    : ::com::sun::star::util::InvalidStateException(Message_, Context_)
{ }

EmptyUndoStackException::EmptyUndoStackException(EmptyUndoStackException const & the_other): ::com::sun::star::util::InvalidStateException(the_other) {}
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::document::EmptyUndoStackException const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::document::EmptyUndoStackException const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::document::EmptyUndoStackException >::get();
}

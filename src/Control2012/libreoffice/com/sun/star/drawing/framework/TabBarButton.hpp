...
inline TabBarButton::TabBarButton(const ::rtl::OUString& ButtonLabel_, const ::rtl::OUString& HelpText_, const ::com::sun::star::uno::Reference< ::com::sun::star::drawing::framework::XResourceId >& ResourceId_) SAL_THROW( () )
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::drawing::framework::TabBarButton const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::drawing::framework::TabBarButton const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::drawing::framework::TabBarButton >::get();
}

...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::form::runtime::XFilterControllerListener const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::uno::Reference< ::com::sun::star::form::runtime::XFilterControllerListener > const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::uno::Reference< ::com::sun::star::form::runtime::XFilterControllerListener > >::get();
}

::com::sun::star::uno::Type const & ::com::sun::star::form::runtime::XFilterControllerListener::static_type(void *) {
    return ::getCppuType(static_cast< ::com::sun::star::uno::Reference< ::com::sun::star::form::runtime::XFilterControllerListener > * >(0));
}

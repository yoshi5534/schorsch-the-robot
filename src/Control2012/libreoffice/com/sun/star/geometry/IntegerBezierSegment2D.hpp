...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::geometry::IntegerBezierSegment2D const *) {
    ...
    if (the_type == 0) {
        ::typelib_TypeDescriptionReference * the_members[] = {
            ...
            ::cppu::UnoType< ::sal_Int32 >::get().getTypeLibType(),
            ::cppu::UnoType< ::sal_Int32 >::get().getTypeLibType() };
        ::typelib_static_struct_type_init(&the_type, "com.sun.star.geometry.IntegerBezierSegment2D", 0, 6, the_members, 0);
    }
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::geometry::IntegerBezierSegment2D const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::geometry::IntegerBezierSegment2D >::get();
}

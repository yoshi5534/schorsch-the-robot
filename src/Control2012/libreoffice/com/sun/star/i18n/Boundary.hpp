...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::i18n::Boundary const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::i18n::Boundary const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::i18n::Boundary >::get();
}

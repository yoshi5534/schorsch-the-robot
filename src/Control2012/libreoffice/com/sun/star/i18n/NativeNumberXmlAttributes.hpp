...
inline NativeNumberXmlAttributes::NativeNumberXmlAttributes(const ::com::sun::star::lang::Locale& Locale_, const ::rtl::OUString& Format_, const ::rtl::OUString& Style_) SAL_THROW( () )
    : Locale(Locale_)
    , Format(Format_)
    , Style(Style_)
{
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::i18n::NativeNumberXmlAttributes const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::i18n::NativeNumberXmlAttributes const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::i18n::NativeNumberXmlAttributes >::get();
}

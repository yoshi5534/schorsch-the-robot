...
inline AlreadyConnectedException::AlreadyConnectedException() SAL_THROW( () )
    : ::com::sun::star::io::IOException()
{ }

inline AlreadyConnectedException::AlreadyConnectedException(const ::rtl::OUString& Message_, const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XInterface >& Context_) SAL_THROW( () )
    : ::com::sun::star::io::IOException(Message_, Context_)
{ }

AlreadyConnectedException::AlreadyConnectedException(AlreadyConnectedException const & the_other): ::com::sun::star::io::IOException(the_other) {}
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::io::AlreadyConnectedException const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::io::AlreadyConnectedException const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::io::AlreadyConnectedException >::get();
}

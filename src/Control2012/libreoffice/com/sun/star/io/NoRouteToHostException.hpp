...
inline NoRouteToHostException::NoRouteToHostException() SAL_THROW( () )
    : ::com::sun::star::io::SocketException()
{ }

inline NoRouteToHostException::NoRouteToHostException(const ::rtl::OUString& Message_, const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XInterface >& Context_) SAL_THROW( () )
    : ::com::sun::star::io::SocketException(Message_, Context_)
{ }

NoRouteToHostException::NoRouteToHostException(NoRouteToHostException const & the_other): ::com::sun::star::io::SocketException(the_other) {}
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::io::NoRouteToHostException const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::io::NoRouteToHostException const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::io::NoRouteToHostException >::get();
}

...
inline InvalidJavaSettingsException::InvalidJavaSettingsException(const ::rtl::OUString& Message_, const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XInterface >& Context_) SAL_THROW( () )
    : ::com::sun::star::java::JavaInitializationException(Message_, Context_)
{ }

InvalidJavaSettingsException::InvalidJavaSettingsException(InvalidJavaSettingsException const & the_other): ::com::sun::star::java::JavaInitializationException(the_other) {}
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::java::InvalidJavaSettingsException const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::java::InvalidJavaSettingsException const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::java::InvalidJavaSettingsException >::get();
}

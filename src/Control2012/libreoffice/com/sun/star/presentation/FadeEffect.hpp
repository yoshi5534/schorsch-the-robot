...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::presentation::FadeEffect const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::presentation::FadeEffect const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::presentation::FadeEffect >::get();
}

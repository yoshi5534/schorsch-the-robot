#ifndef INCLUDED_COM_SUN_STAR_REPORT_REPORTCONTROLMODEL_HPP
#define INCLUDED_COM_SUN_STAR_REPORT_REPORTCONTROLMODEL_HPP
...
private:
    ReportControlModel(); // not implemented
    ReportControlModel(ReportControlModel &); // not implemented
    ~ReportControlModel(); // not implemented
    void operator =(ReportControlModel); // not implemented
};

} } } }

#endif // INCLUDED_COM_SUN_STAR_REPORT_REPORTCONTROLMODEL_HPP

...
inline ArrayWrapper::ArrayWrapper(const ::sal_Bool& IsZeroIndex_, const ::com::sun::star::uno::Any& Array_) SAL_THROW( () )
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::script::ArrayWrapper const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::script::ArrayWrapper const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::script::ArrayWrapper >::get();
}

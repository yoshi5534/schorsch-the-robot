...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::sdb::application::XCopyTableListener const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::uno::Reference< ::com::sun::star::sdb::application::XCopyTableListener > const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::uno::Reference< ::com::sun::star::sdb::application::XCopyTableListener > >::get();
}

::com::sun::star::uno::Type const & ::com::sun::star::sdb::application::XCopyTableListener::static_type(void *) {
    return ::getCppuType(static_cast< ::com::sun::star::uno::Reference< ::com::sun::star::sdb::application::XCopyTableListener > * >(0));
}

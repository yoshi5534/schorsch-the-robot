...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::sdb::tools::XIndexAlteration const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::uno::Reference< ::com::sun::star::sdb::tools::XIndexAlteration > const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::uno::Reference< ::com::sun::star::sdb::tools::XIndexAlteration > >::get();
}

::com::sun::star::uno::Type const & ::com::sun::star::sdb::tools::XIndexAlteration::static_type(void *) {
    return ::getCppuType(static_cast< ::com::sun::star::uno::Reference< ::com::sun::star::sdb::tools::XIndexAlteration > * >(0));
}

...
inline NoPasswordException::NoPasswordException(const ::rtl::OUString& Message_, const ::com::sun::star::uno::Reference< ::com::sun::star::uno::XInterface >& Context_) SAL_THROW( () )
    : ::com::sun::star::uno::SecurityException(Message_, Context_)
{ }

NoPasswordException::NoPasswordException(NoPasswordException const & the_other): ::com::sun::star::uno::SecurityException(the_other) {}
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::security::NoPasswordException const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::security::NoPasswordException const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::security::NoPasswordException >::get();
}

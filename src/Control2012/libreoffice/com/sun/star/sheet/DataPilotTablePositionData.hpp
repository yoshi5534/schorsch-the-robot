...
inline DataPilotTablePositionData::DataPilotTablePositionData(const ::sal_Int32& PositionType_, const ::com::sun::star::uno::Any& PositionData_) SAL_THROW( () )
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::sheet::DataPilotTablePositionData const *) {
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::sheet::DataPilotTablePositionData const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::sheet::DataPilotTablePositionData >::get();
}

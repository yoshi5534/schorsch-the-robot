...
inline RecipientInfo::RecipientInfo() SAL_THROW( () )
    : ProtocolType()
    , State(::com::sun::star::ucb::OutgoingMessageState_WRITTEN)
    , To()
    , CC()
    , BCC()
    , Newsgroups()
...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::ucb::RecipientInfo const *) {
    //TODO: On certain platforms with weak memory models, the following code can result in some threads observing that the_type points to garbage
    static ::typelib_TypeDescriptionReference * the_type = 0;
    if (the_type == 0) {
        ::typelib_TypeDescriptionReference * the_members[] = {
            ::cppu::UnoType< ::rtl::OUString >::get().getTypeLibType(),
            ::cppu::UnoType< ::com::sun::star::ucb::OutgoingMessageState >::get().getTypeLibType(),
            ::cppu::UnoType< ::rtl::OUString >::get().getTypeLibType(),
            ::cppu::UnoType< ::rtl::OUString >::get().getTypeLibType(),
            ::cppu::UnoType< ::rtl::OUString >::get().getTypeLibType(),
            ::cppu::UnoType< ::rtl::OUString >::get().getTypeLibType(),
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::ucb::RecipientInfo const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::ucb::RecipientInfo >::get();
}

...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::uri::RelativeUriExcessParentSegments const *) {
    static typelib_TypeDescriptionReference * the_type = 0;
    if ( !the_type )
    {
        typelib_static_enum_type_init( &the_type,
                                       "com.sun.star.uri.RelativeUriExcessParentSegments",
                                       ::com::sun::star::uri::RelativeUriExcessParentSegments_ERROR );
    }
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::uri::RelativeUriExcessParentSegments const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::uri::RelativeUriExcessParentSegments >::get();
}

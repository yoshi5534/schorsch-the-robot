...
inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(::com::sun::star::xml::crypto::sax::ElementMarkType const *) {
    static typelib_TypeDescriptionReference * the_type = 0;
    if ( !the_type )
    {
        typelib_static_enum_type_init( &the_type,
                                       "com.sun.star.xml.crypto.sax.ElementMarkType",
                                       ::com::sun::star::xml::crypto::sax::ElementMarkType_ELEMENTMARK );
    }
...
inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(::com::sun::star::xml::crypto::sax::ElementMarkType const *) SAL_THROW(()) {
    return ::cppu::UnoType< ::com::sun::star::xml::crypto::sax::ElementMarkType >::get();
}
